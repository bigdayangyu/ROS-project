...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lab7' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab7_baxter/src/lab7/${idir}'.  Ask the maintainer 'ee106a-aai <ee106a-aai@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab7_baxter/devel/lib;/home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab7_baxter/devel/lib;/scratch/shared/baxter_ws/devel/lib;/opt/ros/indigo/lib)
