...
if("FALSE" STREQUAL "TRUE")
  set(lab7_SOURCE_PREFIX /home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab7_baxter/src/lab7)
  set(lab7_DEVEL_PREFIX /home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab7_baxter/devel)
  set(lab7_INSTALL_PREFIX "")
  set(lab7_PREFIX ${lab7_DEVEL_PREFIX})
else()
  set(lab7_SOURCE_PREFIX "")
  set(lab7_DEVEL_PREFIX "")
  set(lab7_INSTALL_PREFIX /home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab7_baxter/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lab7' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ee106a-aai <ee106a-aai@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'lab7' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab7_baxter/install/${idir}'.  Ask the maintainer 'ee106a-aai <ee106a-aai@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab7_baxter/install/lib;/home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab7_baxter/devel/lib;/scratch/shared/baxter_ws/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${lab7_dep}_FOUND)
      find_package(${lab7_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lab7_dep} REQUIRED ${depend_list})
  endif()
