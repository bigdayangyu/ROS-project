...
if("FALSE" STREQUAL "TRUE")
  set(lab3_SOURCE_PREFIX /home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab3_baxter/src/lab3)
  set(lab3_DEVEL_PREFIX /home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab3_baxter/devel)
  set(lab3_INSTALL_PREFIX "")
  set(lab3_PREFIX ${lab3_DEVEL_PREFIX})
else()
  set(lab3_SOURCE_PREFIX "")
  set(lab3_DEVEL_PREFIX "")
  set(lab3_INSTALL_PREFIX /home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab3_baxter/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ee106a-aai <ee106a-aai@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab3_baxter/install/${idir}'.  Ask the maintainer 'ee106a-aai <ee106a-aai@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab3_baxter/install/lib;/home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab3_baxter/devel/lib;/scratch/shared/baxter_ws/devel/lib;/opt/ros/indigo/lib)
