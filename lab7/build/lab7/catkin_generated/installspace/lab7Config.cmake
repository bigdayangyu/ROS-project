...
if("FALSE" STREQUAL "TRUE")
  set(lab7_SOURCE_PREFIX /home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab7/src/lab7)
  set(lab7_DEVEL_PREFIX /home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab7/devel)
  set(lab7_INSTALL_PREFIX "")
  set(lab7_PREFIX ${lab7_DEVEL_PREFIX})
else()
  set(lab7_SOURCE_PREFIX "")
  set(lab7_DEVEL_PREFIX "")
  set(lab7_INSTALL_PREFIX /home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab7/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lab7' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab7/install/${idir}'.  Ask the maintainer 'ee106a-aai <ee106a-aai@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cc/ee106a/fa16/class/ee106a-aai/ros_workspaces/lab7/install/lib;/scratch/shared/baxter_ws/devel/lib;/opt/ros/indigo/lib)
